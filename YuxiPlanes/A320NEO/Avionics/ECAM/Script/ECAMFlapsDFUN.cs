...
namespace YuxiFlightInstruments.ECAM {
    ...
    public class ECAMFlapsDFUN : UdonSharpBehaviour {
        ...
        public void SFEXT_L_EntityStart() {
            ...
            if ((bool)SAVControl.GetProgramVariable("AutoAdjustValuesToMass")) { FlapsExtraMaxLift *= ((Rigidbody)SAVControl.GetProgramVariable("VehicleRigidbody")).mass; }

            if (Dial_Funcon) Dial_Funcon.SetActive(Flaps);
            if (DefaultFlapsOff) { SetFlapsOff(); } else { SetFlapsOn(); }
        }
        ...
        public void SetFlapsOff() {
            ...
            Flaps = false;
            //ECAMController.IsFlapOut = Flaps;
