...
namespace A320VAU.SFEXT
{
    ...
    public class SFEXT_a320_AdvancedGear : UdonSharpBehaviour
    {
        ...
        [Tooltip("最小转向角度,80节时达到 deg")] public float minSteerAngle = 0;
        ...
        [System.NonSerialized] public float maxSteeringCurrent;
        ...
        private float GetTargetMaxSteerAngle(float groundSpeed)
        {
            ...
            float SteerAngle = -1.23333f * groundSpeed + 98.66667f; //20节-74度 80节-0度
