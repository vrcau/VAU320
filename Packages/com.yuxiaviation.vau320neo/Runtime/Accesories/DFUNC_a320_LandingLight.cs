...
namespace A320VAU.DFUNC
{
    ...
    public class DFUNC_a320_LandingLight : UdonSharpBehaviour
    {
        ...
        private void OnDisable() => selected = false;
        ...
        public void SFEXT_G_RespawnButton() => SendCustomNetworkEvent(NetworkEventTarget.All, nameof(TurnOff));
        ...
        public void KeyboardInput() => SendCustomNetworkEvent(NetworkEventTarget.All, !state ? nameof(TurnOn) : nameof(TurnOff));
        ...
        private bool GetTrigger()
        {
            ...
            return Input.GetAxisRaw(useLeftTrigger ? "Oculus_CrossPlatform_PrimaryIndexTrigger" : "Oculus_CrossPlatform_SecondaryIndexTrigger") > .75f;
        }
